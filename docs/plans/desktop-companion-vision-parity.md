...
> Remaining in W3: R4; L3c is deferrable. **W4 started 2026-08-16**:
> **F4 shipped** (user-level MCP reseed for claude + codex) and **L4a
> shipped** (codex attach-rung resolver; L4's WebSocket premise was
> wrong — see the wedge). Left in W4: L4b, R5, R6

...
class ActionBarButton {
  ...
  static const defaultDescriptions = <String, String>{
    ...
    // Native tmux controller actions. Prefix chords cannot control tmux here
    // because TermiPod drives it through exec rather than an attached client.
    'termipod:tmux:new-window': 'Create tmux window',
    'termipod:tmux:next-window': 'Select next tmux window',
    'termipod:tmux:previous-window': 'Select previous tmux window',
    'termipod:tmux:list-windows': 'Choose tmux window',
    'termipod:tmux:rename-window': 'Rename tmux window',
    'termipod:tmux:kill-window': 'Kill tmux window',
    'termipod:tmux:split-horizontal': 'Split tmux pane left/right',
    'termipod:tmux:split-vertical': 'Split tmux pane top/bottom',
    'termipod:tmux:next-pane': 'Select next tmux pane',
    'termipod:tmux:kill-pane': 'Kill tmux pane',
    'termipod:tmux:zoom-pane': 'Toggle tmux pane zoom',
    'termipod:tmux:new-session': 'Create tmux session',
    'termipod:tmux:list-sessions': 'Choose tmux session',
    'termipod:tmux:rename-session': 'Rename tmux session',
    'termipod:tmux:copy-mode': 'Enter tmux copy mode',
    // Shift combos

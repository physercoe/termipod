...
func buildTools() []toolDef {
	tools := []toolDef{
		...
		},
		{
			...
			Description: "Create a new project or a reusable project template. Required: `name` and `kind` ('goal' = finite end-state / 'standing' = ongoing).\n\n" +

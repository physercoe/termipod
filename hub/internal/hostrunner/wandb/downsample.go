...
//
// Copied verbatim from the trackio package so the two readers stay
// fully independent. A shared MetricReader interface is the follow-up
// merge pass noted in research-demo-gaps.md.
//
// Constraints:

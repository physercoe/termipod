...
/// A personal note or todo. Local-only (MVP) — stored in a sqflite DB
/// next to the hub snapshot cache, scoped to this device. The intent
/// is the user's personal scratch space on the Me page: thoughts,
/// reminders, todos that don't belong on a project doc.
///
...
NoteKind _kindFromString(String s) =>
    s == 'todo' ? NoteKind.todo : NoteKind.note;

String _kindToString(NoteKind k) => k == NoteKind.todo ? 'todo' : 'note';

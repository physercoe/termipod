...
> **W4 complete (2026-08-17)**: F4, lane L4 (L4a–L4c), R5 and R6 all
> shipped — codex is drivable locally, a sub-agent's work is attributed
> to it rather than to the main agent, and the composer carries
> model/mode pills. Remaining in the plan: L3c only (deferrable).
